...
- (id)initWithFrame:(CGRect)frame {
    return [self initWithFrame:frame hasDoneButton:YES];
}
...
- (id)initWithFrame:(CGRect)frame hasDoneButton:(BOOL)has {
    ...
    if (self) {
        ...
        if (has) {
            ...
            UIBarButtonItem *doneButton = [[UIBarButtonItem alloc] initWithTitle:lang(@"Done") style:UIBarButtonItemStyleDone target:self action:@selector(resignFirstResponder)];
...
- (void)textViewDidChange:(UITextView *)textView {
    textView.attributedText = [[NSAttributedString alloc] initWithString:textView.text ? textView.text : @"" attributes:[self attributes]];
}
