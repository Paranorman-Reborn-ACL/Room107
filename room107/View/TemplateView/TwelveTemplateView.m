...
@implementation TwelveTemplateView
...
- (id)initWithFrame:(CGRect)frame andTemplateDataDictionary:(NSDictionary *)dataDic {
    ...
    if (self) {
        ...
        DividingLineView *lineView = [[DividingLineView alloc] initWithFrame:(CGRect){0, CGRectGetHeight(frame) - 0.5, CGRectGetWidth(frame), 0.5}];
