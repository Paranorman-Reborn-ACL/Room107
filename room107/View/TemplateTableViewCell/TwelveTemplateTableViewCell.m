...
@interface TwelveTemplateTableViewCell ()
...
@implementation TwelveTemplateTableViewCell
...
- (CGRect)cellFrame {
    return CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, twelveTemplateTableViewCellHeight);
}
