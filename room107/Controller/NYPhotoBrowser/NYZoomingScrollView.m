...
- (void)setObject:(id)object {
    if ([object isKindOfClass:[UIImage class]]) {
        ...
        [self.imageView setImageWithURL:url ? url : @"" placeholderImage:[UIImage imageNamed:@"imageLoading"] withCompletionHandler:^(UIImage *image) {
            // reset
            weakSelf.maximumZoomScale = 1;
            weakSelf.minimumZoomScale = 1;
            weakSelf.zoomScale = 1;
            weakSelf.contentSize = CGSizeZero;
            ...
            if (image) {
                ...
                weakSelf.contentSize = imageViewFrame.size;
